...
export class BugReportService {
     ...
     */
    generateBugReport(testName, rawError, platform, deviceName, appVersion) {
...
`;
    ...
    extractErrorSummary(error) {
        ...
        const errorLine = lines.find(l => l.includes('Error:') || l.includes('FAILED') || l.includes('AssertionError') || l.includes('NoSuchElement'));
